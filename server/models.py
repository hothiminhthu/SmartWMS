...
class Product(Document):
    ...
    cpu: Optional[str] = None       # VD: Core i5, M3, Snapdragon 8 Gen 3
    ram: Optional[str] = None       # VD: 8GB, 16GB
    storage: Optional[str] = None   # VD: 512GB SSD, 256GB
    color: Optional[str] = None     # VD: Titan Tự Nhiên, Đen nhám
